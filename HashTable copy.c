 //
//  Created by Xuqiang Fang on 05/01/2018.
//  Copyright © 2018 Xuqiang Fang. All rights reserved.
//
#include <stdio.h>
//#include "hashtable.c"
...
//Use linked list as the basic hashtable element structure
...
void* ht_put(hashtable_t* hasht, char* key, void* data)
{
    ...
    while(e != NULL)
    {
        if(!strcmp(e->key, key))// the keys are not the same
        {
            void* ret = e->data;
            e->data = data;
            return ret;
